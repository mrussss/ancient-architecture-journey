...
export class LevelSelectScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    this.add.text(WINDOW_WIDTH / 2, 92, '选择关卡 / Select Level', {
    ...
    levels.forEach((level, index) => {
      ...
      new Button(this, x, y + 44, 290, 58, `${level.id}. ${level.title.replace(/^Level \\d+: /, '')}`, () => {
    ...
    new Button(this, WINDOW_WIDTH / 2, 474, 220, 46, 'Back', () => this.scene.start('MainMenuScene'));
