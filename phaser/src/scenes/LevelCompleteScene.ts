...
export class LevelCompleteScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    this.add.text(WINDOW_WIDTH / 2, 118, `${level.title.split('：')[0]}完成`, {
      fontFamily: 'Arial, "Microsoft YaHei", sans-serif',
      fontSize: '32px',
      color: '#ffe08a'
    }).setOrigin(0.5);
    this.add.text(WINDOW_WIDTH / 2, 166, `残页归卷：${this.pagesCollected} / ${this.totalPages}`, {
      fontFamily: 'Arial, "Microsoft YaHei", sans-serif',
      fontSize: '20px',
      color: '#e8dcc2'
    }).setOrigin(0.5);
    this.add.text(WINDOW_WIDTH / 2, 226, this.summaryForLevel(this.levelId), {
      fontFamily: 'Arial, "Microsoft YaHei", sans-serif',
      fontSize: '17px',
      color: '#efe2c5',
      align: 'center',
    ...
    new Button(this, WINDOW_WIDTH / 2, 366, 250, 44, '重访本章', () => this.scene.start('GameScene', { levelId: this.levelId }));
